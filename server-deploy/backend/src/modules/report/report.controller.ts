...
export class ReportController {
  ...
  async list(
    ...
    return this.service.list({
      ...
      status: status !== undefined ? +status : undefined, startDate, endDate,
    });
  }
  ...
  async comparison(@Param('customerId') customerId, @Query('templateCode') templateCode) {
    return this.service.getComparison(customerId, templateCode);
  }
