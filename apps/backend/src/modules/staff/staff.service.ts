...
import { parsePermissions } from '../../common/utils/permissions';
...
export class StaffService {
  ...
  async list(params) {
    ...
    items.forEach((i) => { delete i.password; i.permissions = parsePermissions(i.permissions); });
  ...
  async findOne(id) {
    ...
    staff.permissions = parsePermissions(staff.permissions);
    return staff;
  }
